...
from temporal_transforms import LoopPadding, TemporalRandomCrop, TemporalStride, TemporalEndCrop
...
if __name__ == '__main__':
    ...
    if not opt.no_train:
        ...
        temporal_transform = Compose([ TemporalEndCrop(opt.sample_duration)])
